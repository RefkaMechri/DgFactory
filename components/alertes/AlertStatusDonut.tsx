// AlertStatusDonut.tsx
import { statusData } from "@/data/alerts";
  ...
  return (
    <div className="h-full rounded-2xl border border-slate-100 bg-white p-4 shadow-sm">
      ...
      <div className="flex flex-col items-center gap-4 md:flex-row">
        <div className="relative flex h-32 w-32 shrink-0 items-center justify-center rounded-full bg-[conic-gradient(#EF8FA0_0_43%,#EDB97D_43%_71%,#8FD1A8_71%_97%,#D7DCE3_97%_100%)]">
