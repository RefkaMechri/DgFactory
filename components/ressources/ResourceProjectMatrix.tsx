        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 text-xs font-bold text-slate-400">
            <tr>
              ...
              <th className="px-4 py-3 text-center">App Mobile</th>
              <th className="px-4 py-3 text-center">Refonte SI Crédit</th>
              <th className="px-4 py-3 text-center">Open Banking</th>
              <th className="px-4 py-3 text-center">Paiement Instantané</th>
              <th className="px-4 py-3 text-center">Data & Analytics</th>
          ...
          <tbody className="divide-y divide-slate-100 bg-white">
            {resourceMatrix.map((item) => (
              <tr key={item.resource}>
                ...
                <td className="px-4 py-4 font-bold text-blue-500">
                  {item.department}
                </td>
            ...
            <tr className="bg-slate-50">
              <td className="px-4 py-4 font-black text-slate-900" colSpan={3}>
