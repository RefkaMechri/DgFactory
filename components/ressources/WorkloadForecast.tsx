...
function getBadgeStyle(value: string) {
  ...
  if (numeric >= 75) return "bg-[#FFF3D0] text-[#B8790A]";
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 text-xs font-bold text-slate-400">
            <tr>
              ...
              <th className="px-3 py-2.5 text-center">S21</th>
              <th className="px-3 py-2.5 text-center">S22</th>
              <th className="px-3 py-2.5 text-center">S23</th>
              <th className="px-3 py-2.5 text-center">S24</th>
              <th className="px-3 py-2.5 text-center">Tendance</th>
            </tr>
          </thead>
          ...
          <tbody className="divide-y divide-slate-100 bg-white">
            {workloadForecast.map((row) => (
              ...
              >
                ...
                <td className="px-3 py-3 text-center text-lg font-black text-[#3D6FC9]">
                  {row.trend}
                </td>
              </tr>
            ))}
